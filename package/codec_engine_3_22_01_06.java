...
public class codec_engine_3_22_01_06
{
    ...
    void $$IMPORTS()
    {
        ...
        Global.callFxn("loadPackage", xdcO, "ti.sdo.ce.views");
        ...
        Global.callFxn("loadPackage", xdcO, "ti.sdo.ce.utils.syscbuf");
        Global.callFxn("loadPackage", xdcO, "ti.sdo.ce.utils.rtcfg");
        Global.callFxn("loadPackage", xdcO, "ti.sdo.ce.utils.rtcfg.osal");
        ...
        Global.callFxn("loadPackage", xdcO, "ti.sdo.ce.examples.codecs.videnc2_copy");
        ...
        Global.callFxn("loadPackage", xdcO, "ti.sdo.ce.examples.codecs.viddec3_copy");
        ...
        Global.callFxn("loadPackage", xdcO, "ti.sdo.ce.examples.apps.video3_copy");
    ...
    void $$OBJECTS()
    {
        pkgP = (Proto.Obj)om.bind("codec_engine_3_22_01_06.Package", new Proto.Obj());
        pkgV = (Value.Obj)om.bind("codec_engine_3_22_01_06", new Value.Obj("codec_engine_3_22_01_06", pkgP));
    }

    void $$SINGLETONS()
    {
        pkgP.init("codec_engine_3_22_01_06.Package", (Proto.Obj)om.findStrict("xdc.IPackage.Module", "codec_engine_3_22_01_06"));
        pkgP.bind("$capsule", $$UNDEF);
        pkgV.init2(pkgP, "codec_engine_3_22_01_06", Value.DEFAULT, false);
        pkgV.bind("$name", "codec_engine_3_22_01_06");
        pkgV.bind("$category", "Package");
        pkgV.bind("$$qn", "codec_engine_3_22_01_06.");
        ...
        imports.add(Global.newArray("ti.sdo.ce.views", Global.newArray()));
        ...
        imports.add(Global.newArray("ti.sdo.ce.utils.syscbuf", Global.newArray()));
        imports.add(Global.newArray("ti.sdo.ce.utils.rtcfg", Global.newArray()));
        imports.add(Global.newArray("ti.sdo.ce.utils.rtcfg.osal", Global.newArray()));
        ...
        imports.add(Global.newArray("ti.sdo.ce.examples.codecs.videnc2_copy", Global.newArray()));
        ...
        imports.add(Global.newArray("ti.sdo.ce.examples.codecs.viddec3_copy", Global.newArray()));
        ...
        imports.add(Global.newArray("ti.sdo.ce.examples.apps.video3_copy", Global.newArray()));
        ...
        sb.append("var pkg = xdc.om['codec_engine_3_22_01_06'];\n");
    ...
    void $$INITIALIZATION()
    {
        ...
        ((Value.Arr)om.findStrict("$packages", "codec_engine_3_22_01_06")).add(pkgV);
    }
