...
# Generated by build.filter.Make on Thu Feb 23 2012 17:50:14 GMT-0800 (PST)
#
...
.objs/cesettings_CESettings.ov5T: CESettings.c
...
all: .objs/cesettings_CESettings.ov5T
clean::
	-$(RM) .objs/cesettings_CESettings.ov5T

$(LIBDIR)/cesettings.av5T: .objs/cesettings_CESettings.ov5T 
	 $(CGTOOLS_V5T)/$(AR_V5T) cr $@ $^
all: $(LIBDIR)/cesettings.av5T
clean::
	-$(RM) $(LIBDIR)/cesettings.av5T
#
