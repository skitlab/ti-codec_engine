...
public class ti_sdo_ce
{
    ...
    void Engine$$TYPES()
    {
        ...
        po.addFld("initFromServer", $$T_Bool, true, "wh");
        ...
        po.addFld("heapId", Proto.Elm.newCNum("(xdc_UInt32)"), $$UNDEF, "wh");
        po.addFld("armDspLinkConfig", (Proto)om.findStrict("ti.sdo.ce.ipc.IIpc.ArmDspLinkConfig", "ti.sdo.ce"), $$DEFAULT, "wh");
        po.addFld("useExtLoader", $$T_Bool, false, "wh");
        po.addFld("memMap", $$T_Str, $$UNDEF, "wh");
    ...
    void $$SINGLETONS()
    {
        ...
        sb.append("pkg.build.libraries = [\n");
            sb.append("'lib/debug/ce.aem3',\n");
            sb.append("'lib/release/ce.aem3',\n");
            sb.append("'lib/debug/ce.ae674',\n");
            sb.append("'lib/release/ce.ae674',\n");
            sb.append("'lib/debug/ce.av5T',\n");
            sb.append("'lib/release/ce.av5T',\n");
        sb.append("];\n");
        sb.append("pkg.build.libDesc = [\n");
            sb.append("['lib/debug/ce.aem3', {target: 'ti.targets.arm.elf.M3', suffix: 'em3'}],\n");
            sb.append("['lib/release/ce.aem3', {target: 'ti.targets.arm.elf.M3', suffix: 'em3'}],\n");
            sb.append("['lib/debug/ce.ae674', {target: 'ti.targets.elf.C674', suffix: 'e674'}],\n");
            sb.append("['lib/release/ce.ae674', {target: 'ti.targets.elf.C674', suffix: 'e674'}],\n");
            sb.append("['lib/debug/ce.av5T', {target: 'gnu.targets.arm.GCArmv5T', suffix: 'v5T'}],\n");
            sb.append("['lib/release/ce.av5T', {target: 'gnu.targets.arm.GCArmv5T', suffix: 'v5T'}],\n");
        sb.append("];\n");
        Global.eval(sb.toString());
    }
