 ...
 *  Use this file to build Linux apps with remote DSP server for the evm3530
 *  with debug libraries.
 */
INPUT(
    ...
    ti/sdo/ce/ipc/dsplink/lib/debug/ipc_syslink.av5T
    ...
    ti/syslink/lib/syslink.a_debug
