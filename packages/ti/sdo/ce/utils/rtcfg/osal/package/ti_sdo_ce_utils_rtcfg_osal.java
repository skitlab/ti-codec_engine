...
public class ti_sdo_ce_utils_rtcfg_osal
{
    ...
    void $$OBJECTS()
    {
        ...
        pkgV = (Value.Obj)om.bind("ti.sdo.ce.utils.rtcfg.osal", new Value.Obj("ti.sdo.ce.utils.rtcfg.osal", pkgP));
    }

    void $$SINGLETONS()
    {
        pkgP.init("ti.sdo.ce.utils.rtcfg.osal.Package", (Proto.Obj)om.findStrict("xdc.IPackage.Module", "ti.sdo.ce.utils.rtcfg.osal"));
