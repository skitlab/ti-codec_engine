...
.objs/TraceUtil_TraceUtil.ov5T: TraceUtil.c
...
all: .objs/TraceUtil_TraceUtil.ov5T
clean::
	-$(RM) .objs/TraceUtil_TraceUtil.ov5T

$(LIBDIR)/TraceUtil.av5T: .objs/TraceUtil_TraceUtil.ov5T 
	 $(CGTOOLS_V5T)/$(AR_V5T) cr $@ $^
all: $(LIBDIR)/TraceUtil.av5T
clean::
	-$(RM) $(LIBDIR)/TraceUtil.av5T
#
