...
.objs/XdmUtils_XdmUtils.ov5T: XdmUtils.c
...
all: .objs/XdmUtils_XdmUtils.ov5T
clean::
	-$(RM) .objs/XdmUtils_XdmUtils.ov5T

$(LIBDIR)/XdmUtils.av5T: .objs/XdmUtils_XdmUtils.ov5T 
	 $(CGTOOLS_V5T)/$(AR_V5T) cr $@ $^
all: $(LIBDIR)/XdmUtils.av5T
clean::
	-$(RM) $(LIBDIR)/XdmUtils.av5T
#
