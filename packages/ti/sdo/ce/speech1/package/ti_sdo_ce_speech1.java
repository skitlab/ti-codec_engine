...
public class ti_sdo_ce_speech1
{
    ...
    void $$SINGLETONS()
    {
        ...
        sb.append("pkg.build.libraries = [\n");
            sb.append("'lib/debug/sphdec1.aem3',\n");
            sb.append("'lib/debug/sphenc1.aem3',\n");
            sb.append("'lib/release/sphdec1.aem3',\n");
            sb.append("'lib/release/sphenc1.aem3',\n");
            sb.append("'lib/debug/sphdec1.ae674',\n");
            sb.append("'lib/debug/sphenc1.ae674',\n");
            sb.append("'lib/release/sphdec1.ae674',\n");
            sb.append("'lib/release/sphenc1.ae674',\n");
        ...
        sb.append("pkg.build.libDesc = [\n");
            sb.append("['lib/debug/sphdec1.aem3', {target: 'ti.targets.arm.elf.M3', suffix: 'em3'}],\n");
            sb.append("['lib/debug/sphenc1.aem3', {target: 'ti.targets.arm.elf.M3', suffix: 'em3'}],\n");
            sb.append("['lib/release/sphdec1.aem3', {target: 'ti.targets.arm.elf.M3', suffix: 'em3'}],\n");
            sb.append("['lib/release/sphenc1.aem3', {target: 'ti.targets.arm.elf.M3', suffix: 'em3'}],\n");
            sb.append("['lib/debug/sphdec1.ae674', {target: 'ti.targets.elf.C674', suffix: 'e674'}],\n");
            sb.append("['lib/debug/sphenc1.ae674', {target: 'ti.targets.elf.C674', suffix: 'e674'}],\n");
            sb.append("['lib/release/sphdec1.ae674', {target: 'ti.targets.elf.C674', suffix: 'e674'}],\n");
            sb.append("['lib/release/sphenc1.ae674', {target: 'ti.targets.elf.C674', suffix: 'e674'}],\n");
            sb.append("['lib/debug/sphdec1.av5T', {target: 'gnu.targets.arm.GCArmv5T', suffix: 'v5T'}],\n");
            sb.append("['lib/debug/sphenc1.av5T', {target: 'gnu.targets.arm.GCArmv5T', suffix: 'v5T'}],\n");
            sb.append("['lib/release/sphdec1.av5T', {target: 'gnu.targets.arm.GCArmv5T', suffix: 'v5T'}],\n");
            sb.append("['lib/release/sphenc1.av5T', {target: 'gnu.targets.arm.GCArmv5T', suffix: 'v5T'}],\n");
        sb.append("];\n");
