...
# Generated by build.filter.Make on Thu Feb 23 2012 17:50:25 GMT-0800 (PST)
#
...
.objs/ipc_linux_Processor_posix.ov5T: Processor_posix.c
...
all: .objs/ipc_linux_Processor_posix.ov5T
clean::
	-$(RM) .objs/ipc_linux_Processor_posix.ov5T

.objs/ipc_linux_Comm_posix.ov5T: Comm_posix.c
	 $(CGTOOLS_V5T)/$(CC_V5T) -c -MD -MF $@.dep -x c  -fPIC -Wunused -Wall -fno-strict-aliasing  -march=armv5t -Dfar=  -Dxdc_target_name__=GCArmv5T -Dxdc_target_types__=gnu/targets/arm/std.h -Dxdc_bld__profile_release -Dxdc_bld__vers_1_0_4_2_1 -O2 -ffunction-sections  $(INCS)  -o $@ $<
	 
all: .objs/ipc_linux_Comm_posix.ov5T
clean::
	-$(RM) .objs/ipc_linux_Comm_posix.ov5T

$(LIBDIR)/ipc_linux.av5T: .objs/ipc_linux_Processor_posix.ov5T .objs/ipc_linux_Comm_posix.ov5T 
	 $(CGTOOLS_V5T)/$(AR_V5T) cr $@ $^
all: $(LIBDIR)/ipc_linux.av5T
clean::
	-$(RM) $(LIBDIR)/ipc_linux.av5T
#
