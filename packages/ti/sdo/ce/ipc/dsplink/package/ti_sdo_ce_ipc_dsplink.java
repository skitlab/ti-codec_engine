...
public class ti_sdo_ce_ipc_dsplink
{
    ...
    void Processor$$OBJECTS()
    {
        ...
        po = (Proto.Obj)om.bind("ti.sdo.ce.ipc.dsplink.Processor.Module", new Proto.Obj());
        vo = (Value.Obj)om.bind("ti.sdo.ce.ipc.dsplink.Processor", new Value.Obj("ti.sdo.ce.ipc.dsplink.Processor", po));
        pkgV.bind("Processor", vo);
        // decls 
        spo = (Proto.Obj)om.bind("ti.sdo.ce.ipc.dsplink.Processor$$CommDesc", new Proto.Obj());
        om.bind("ti.sdo.ce.ipc.dsplink.Processor.CommDesc", new Proto.Str(spo, true));
    }
    ...
    void Processor$$FUNCTIONS()
    {
        ...
        // fxn Processor.close
        fxn = (Proto.Fxn)om.bind("ti.sdo.ce.ipc.dsplink.Processor$$close", new Proto.Fxn(om.findStrict("ti.sdo.ce.ipc.dsplink.Processor.Module", "ti.sdo.ce.ipc.dsplink"), null, 0, -1, false));
    }
    ...
    void Processor$$TYPES()
    {
        ...
        cap = (Scriptable)Global.callFxn("loadCapsule", xdcO, "ti/sdo/ce/ipc/dsplink/Processor.xs");
        om.bind("ti.sdo.ce.ipc.dsplink.Processor$$capsule", cap);
        po = (Proto.Obj)om.findStrict("ti.sdo.ce.ipc.dsplink.Processor.Module", "ti.sdo.ce.ipc.dsplink");
        po.init("ti.sdo.ce.ipc.dsplink.Processor.Module", $$Module);
                po.addFld("$hostonly", $$T_Num, 1, "r");
        po.addFld("sharedRegionId", Proto.Elm.newCNum("(xdc_UInt16)"), 0L, "wh");
        po.addFld("heapId", Proto.Elm.newCNum("(xdc_UInt16)"), 0L, "wh");
        po.addFld("loadSlave", $$T_Bool, true, "wh");
        po.addFld("coreComm", new Proto.Arr((Proto)om.findStrict("ti.sdo.ce.ipc.dsplink.Processor.CommDesc", "ti.sdo.ce.ipc.dsplink"), false), $$DEFAULT, "wh");
        fxn = Global.get(cap, "module$use");
        if (fxn != null) om.bind("ti.sdo.ce.ipc.dsplink.Processor$$module$use", true);
        if (fxn != null) po.addFxn("module$use", $$T_Met, fxn);
        fxn = Global.get(cap, "module$meta$init");
        if (fxn != null) om.bind("ti.sdo.ce.ipc.dsplink.Processor$$module$meta$init", true);
        if (fxn != null) po.addFxn("module$meta$init", $$T_Met, fxn);
        fxn = Global.get(cap, "module$validate");
        if (fxn != null) om.bind("ti.sdo.ce.ipc.dsplink.Processor$$module$validate", true);
        if (fxn != null) po.addFxn("module$validate", $$T_Met, fxn);
                po.addFxn("close", (Proto.Fxn)om.findStrict("ti.sdo.ce.ipc.dsplink.Processor$$close", "ti.sdo.ce.ipc.dsplink"), Global.get(cap, "close"));
        // struct Processor.CommDesc
        po = (Proto.Obj)om.findStrict("ti.sdo.ce.ipc.dsplink.Processor$$CommDesc", "ti.sdo.ce.ipc.dsplink");
        po.init("ti.sdo.ce.ipc.dsplink.Processor.CommDesc", null);
                po.addFld("$hostonly", $$T_Num, 1, "r");
    ...
    void $$SINGLETONS()
    {
        ...
        sb.append("pkg.build.libraries = [\n");
            sb.append("'lib/debug/ipc_syslink.av5T',\n");
            sb.append("'lib/release/ipc_syslink.av5T',\n");
        sb.append("];\n");
        sb.append("pkg.build.libDesc = [\n");
            sb.append("['lib/debug/ipc_syslink.av5T', {target: 'gnu.targets.arm.GCArmv5T', suffix: 'v5T'}],\n");
            sb.append("['lib/release/ipc_syslink.av5T', {target: 'gnu.targets.arm.GCArmv5T', suffix: 'v5T'}],\n");
        sb.append("];\n");
    ...
    void DspLinkCfg$$SINGLETONS()
    {
        ...
        vo.bind("$$mcfgs", Global.newArray(mcfgs.toArray()));
        vo.bind("$$icfgs", Global.newArray(icfgs.toArray()));
        inherits.add("ti.sdo.ce.ipc.dsplink");
        vo.bind("$$inherits", Global.newArray(inherits.toArray()));
        ((Value.Arr)pkgV.getv("$modules")).add(vo);
        ((Value.Arr)om.findStrict("$modules", "ti.sdo.ce.ipc.dsplink")).add(vo);
        vo.bind("$$instflag", 0);
    ...
    void Processor$$SINGLETONS()
    {
        ...
        vo = (Value.Obj)om.findStrict("ti.sdo.ce.ipc.dsplink.Processor", "ti.sdo.ce.ipc.dsplink");
        po = (Proto.Obj)om.findStrict("ti.sdo.ce.ipc.dsplink.Processor.Module", "ti.sdo.ce.ipc.dsplink");
        vo.init2(po, "ti.sdo.ce.ipc.dsplink.Processor", $$DEFAULT, false);
        vo.bind("Module", po);
        vo.bind("$category", "Module");
        vo.bind("$capsule", om.findStrict("ti.sdo.ce.ipc.dsplink.Processor$$capsule", "ti.sdo.ce.ipc.dsplink"));
        vo.bind("$package", om.findStrict("ti.sdo.ce.ipc.dsplink", "ti.sdo.ce.ipc.dsplink"));
        tdefs.clear();
        proxies.clear();
        mcfgs.clear();
        icfgs.clear();
        inherits.clear();
        vo.bind("CommDesc", om.findStrict("ti.sdo.ce.ipc.dsplink.Processor.CommDesc", "ti.sdo.ce.ipc.dsplink"));
        tdefs.add(om.findStrict("ti.sdo.ce.ipc.dsplink.Processor.CommDesc", "ti.sdo.ce.ipc.dsplink"));
        vo.bind("$$tdefs", Global.newArray(tdefs.toArray()));
        vo.bind("$$proxies", Global.newArray(proxies.toArray()));
        vo.bind("$$mcfgs", Global.newArray(mcfgs.toArray()));
        vo.bind("$$icfgs", Global.newArray(icfgs.toArray()));
        ...
        Proto.Str ps = (Proto.Str)vo.find("Module_State");
        if (ps != null) vo.bind("$object", ps.newInstance());
        vo.bind("$$meta_iobj", om.has("ti.sdo.ce.ipc.dsplink.Processor$$instance$static$init", null) ? 1 : 0);
        vo.bind("$$fxntab", Global.newArray());
        vo.bind("$$logEvtCfgs", Global.newArray());
        vo.bind("$$errorDescCfgs", Global.newArray());
        vo.bind("$$assertDescCfgs", Global.newArray());
    ...
    void $$INITIALIZATION()
    {
        ...
        Global.callFxn("module$meta$init", (Scriptable)om.findStrict("ti.sdo.ce.ipc.dsplink.Processor", "ti.sdo.ce.ipc.dsplink"));
        ...
        ((Value.Obj)om.getv("ti.sdo.ce.ipc.dsplink.Processor")).bless();
